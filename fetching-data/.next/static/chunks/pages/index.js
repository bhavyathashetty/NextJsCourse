...
/***/ "./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2F&absolutePagePath=C%3A%5CUsers%5Cuser%5CDesktop%5Cnextnew%5Ccourse%5Cfetching-data%5Cpages%5Cindex.js!":
/*!*************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/next/dist/build/webpack/loaders/next-client-pages-loader.js?page=%2F&absolutePagePath=C%3A%5CUsers%5Cuser%5CDesktop%5Cnextnew%5Ccourse%5Cfetching-data%5Cpages%5Cindex.js! ***!
  \*************************************************************************************************************************************************************************************************/
...
/* harmony export */   "CONCURRENT_PROMISES": function() { return /* binding */ CONCURRENT_PROMISES; },
/* harmony export */   "CONCURRENT_PROMISES_TS": function() { return /* binding */ CONCURRENT_PROMISES_TS; },
/* harmony export */   "FOCUS_REVALIDATORS": function() { return /* binding */ FOCUS_REVALIDATORS; },
/* harmony export */   "CACHE_REVALIDATORS": function() { return /* binding */ CACHE_REVALIDATORS; },
/* harmony export */   "MUTATION_TS": function() { return /* binding */ MUTATION_TS; },
/* harmony export */   "cacheGet": function() { return /* binding */ cacheGet; },
/* harmony export */   "cacheSet": function() { return /* binding */ cacheSet; },
/* harmony export */   "cacheClear": function() { return /* binding */ cacheClear; }
/* harmony export */ });
...
if (typeof window !== 'undefined' && window.addEventListener && !eventsBinded) {
    const revalidate = () => {
        if (!(0,_libs_is_document_visible__WEBPACK_IMPORTED_MODULE_1__.default)() || !(0,_libs_is_online__WEBPACK_IMPORTED_MODULE_2__.default)())
            return;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "useSWRPages": function() { return /* reexport safe */ _use_swr_pages__WEBPACK_IMPORTED_MODULE_1__.useSWRPages; }
/* harmony export */ });
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _use_swr__WEBPACK_IMPORTED_MODULE_0__) if(["default","useSWRPages"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) __WEBPACK_REEXPORT_OBJECT__[__WEBPACK_IMPORT_KEY__] = function(key) { return _use_swr__WEBPACK_IMPORTED_MODULE_0__[key]; }.bind(0, __WEBPACK_IMPORT_KEY__)
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "useSWRPages": function() { return /* binding */ useSWRPages; }
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
function useSWRPages(pageKey, pageFn, SWRToOffset, deps = []) {
    ...
    const [pageCount, setPageCount] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)((0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheGet)(pageCountKey) || 1);
    const [pageOffsets, setPageOffsets] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)((0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheGet)(pageOffsetKey) || [null]);
    const [pageSWRs, setPageSWRs] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
    const pageFnRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(pageFn);
    const emptyPageRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(false);
    // Page component (wraps `pageFn`)
    // for performance reason we need to memorize it
    const Page = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(props => {
    ...
    const loadMore = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(() => {
        if (isLoadingMore || isReachingEnd)
            return;
        setPageCount(c => {
            (0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheSet)(pageCountKey, c + 1);
            return c + 1;
        });
    }, [isLoadingMore || isReachingEnd]);
    const _pageFn = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(pageFn, deps);
    ...
    const pages = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
                ...
                if (typeof swr.data !== 'undefined') {
                    ...
                    if (pageOffsets[id + 1] !== newPageOffset) {
                        setPageOffsets(arr => {
                            ...
                            (0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheSet)(pageOffsetKey, _arr);
                            return _arr;
                        });
                    }
                }
        ...
        for (let i = 0; i < pageCount; ++i) {
            if (!pageCache[i] ||
                ...
                pageCache[i] = {
                    component: (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Page, { key: `page-${pageOffsets[i]}-${i}`, offset: pageOffsets[i], withSWR: getWithSWR(i) })),
                    pageFn: _pageFn,
...
const getKeyArgs = key => {
    ...
    if (Array.isArray(key)) {
        // args array
        args = key;
        key = (0,_libs_hash__WEBPACK_IMPORTED_MODULE_2__.default)(key);
    }
    else {
        // convert null to ''
        key = String(key || '');
...
const trigger = (_key, shouldRevalidate = true) => {
    ...
    if (key && updaters) {
        const currentData = (0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheGet)(key);
        const currentError = (0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheGet)(getErrorKey(key));
...
const mutate = async (_key, _data, shouldRevalidate = true) => {
    ...
    if (_data && typeof _data === 'function') {
        ...
        try {
            data = await _data((0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheGet)(key));
        }
        catch (err) {
            error = err;
        }
    ...
    if (typeof data !== 'undefined') {
        // update cached data
        (0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheSet)(key, data);
    }
...
function useSWR(...args) {
    ...
    config = Object.assign({}, _config__WEBPACK_IMPORTED_MODULE_1__.default, (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_swr_config_context__WEBPACK_IMPORTED_MODULE_6__.default), config);
    if (typeof fn === 'undefined') {
        // use a global fetcher
        fn = config.fetcher;
    }
    const initialData = (0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheGet)(key) || config.initialData;
    const initialError = (0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheGet)(keyErr);
    // if a state is accessed (data, error or isValidating),
    // we add the state to dependencies so if the state is
    // updated in the future, we can trigger a rerender
    const stateDependencies = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)({
        data: false,
        error: false,
        isValidating: false
    });
    ...
    const rerender = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null)[1];
    let dispatch = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(payload => {
    ...
    const boundMutate = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)((data, shouldRevalidate) => {
    ...
    const revalidate = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(async (revalidateOpts = {}) => {
        ...
        try {
            ...
            if (shouldDeduping) {
                ...
                if (config.loadingTimeout && !(0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheGet)(key)) {
                    setTimeout(() => {
                        if (loading)
            ...
            (0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheSet)(key, newData);
            (0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheSet)(keyErr, undefined);
            keyRef.current = key;
            ...
            delete _config__WEBPACK_IMPORTED_MODULE_1__.CONCURRENT_PROMISES[key];
            delete _config__WEBPACK_IMPORTED_MODULE_1__.CONCURRENT_PROMISES_TS[key];
            (0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheSet)(keyErr, err);
            keyRef.current = key;
            // get a new error
    ...
    useIsomorphicLayoutEffect(() => {
        ...
        const latestKeyedData = (0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheGet)(key) || config.initialData;
        ...
        if (config.revalidateOnFocus) {
            ...
            onFocus = (0,_libs_throttle__WEBPACK_IMPORTED_MODULE_5__.default)(softRevalidate, config.focusThrottleInterval);
    ...
    useIsomorphicLayoutEffect(() => {
        ...
        const tick = async () => {
            if (!stateRef.current.error &&
                (config.refreshWhenHidden || (0,_libs_is_document_visible__WEBPACK_IMPORTED_MODULE_3__.default)()) &&
                (!config.refreshWhenOffline && (0,_libs_is_online__WEBPACK_IMPORTED_MODULE_4__.default)())) {
    ...
    if (config.suspense) {
        ...
        let latestData = (0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheGet)(key);
        let latestError = (0,_config__WEBPACK_IMPORTED_MODULE_1__.cacheGet)(keyErr);
